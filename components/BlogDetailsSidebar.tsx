    ...
    <div>
      ...
      >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          {`Team Novastra observed that stagnating companies need more than templated advice, PowerPoint decks, and periodic check-ins with a traditional advisor. Novastra and its team are true partners and transformational architects who walk the journey with you, physically, mentally, emotionally, and spiritually.`}
        </motion.p>
