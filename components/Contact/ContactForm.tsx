        ...
        <div className="mt-4">
          ...
          {loading ? (
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <button
                type="submit"
                className="bg-primary text-white px-6 py-2.5 rounded-xl text-base hover:bg-primary/80 transition duration-300 shadow-sm hover:shadow-md font-open-sans uppercase cursor-pointer w-full"
              >
                Send Message
              </button>
            </motion.div>
